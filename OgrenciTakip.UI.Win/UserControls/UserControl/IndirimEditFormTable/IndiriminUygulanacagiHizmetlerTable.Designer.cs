...
namespace OgrenciTakip.UI.Win.UserControls.UserControl.IndirimEditFormTable
{
	partial class IndiriminUygulanacagiHizmetlerTable
	{
        ...
        private void InitializeComponent()
        {
			...
			// insUptNavigator
			// 
			this.insUptNavigator.Location = new System.Drawing.Point(0, 225);
			this.insUptNavigator.Size = new System.Drawing.Size(420, 24);
			// 
			// grid
			// 
            ...
            this.repositoryOran});
			this.grid.Size = new System.Drawing.Size(420, 225);
			...
			this.tablo.ViewCaption = "İndirimin Uygulanacaği Hizmetler";
			// 
			// colHizmetAdi
			// 
			...
			this.colHizmetAdi.StatusBarAciklama = "";
			...
			this.colIndirimTutari.Width = 120;
			// 
			// repositoryTutar
			// 
