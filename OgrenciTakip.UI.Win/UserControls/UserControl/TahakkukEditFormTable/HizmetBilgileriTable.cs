...
namespace OgrenciTakip.UI.Win.UserControls.UserControl.TahakkukEditFormTable
{
	public partial class HizmetBilgileriTable : BaseTablo
    {
        public HizmetBilgileriTable()
        {
            ...
            Business = new HizmetBilgileriBusiness();
            Tablo = tablo;
            EventsLoad();
        ...
        {
            tablo.GridControl.DataSource = ((HizmetBilgileriBusiness)Business).List(x => x.TahakkukId == OwnerForm.Id).ToBindingList<HizmetBilgileriL>();
        }
        ...
        protected override void IptalEt()
        {
			...
			tablo.UpdateSummary();  //Toplamları Güncelle
			tablo.RowCellEnabled(); //hücreye yazı yazma olayını açar
        ...
        protected override void IptalGeriAl()
        {
            ...
            if (Messages.IptalGeriAlMesajMesaj(entity.HizmetAdi) != DialogResult.Yes) return;
        ...
        protected override void RowCellAllowEdit()
        {
            ...
            colIptalAcıklama.OptionsColumn.AllowEdit = entity.IptalEdildi;
		...
		protected override void Tablo_CellValueChanged(object sender, CellValueChangedEventArgs e)
		{
			...
			else if (e.Column == colIptalAcıklama)
