...
namespace OgrenciTakip.UI.Win.UserControls.UserControl.TahakkukEditFormTable
{
	public partial class OdemeBilgileriTable : BaseTablo
	{
		public OdemeBilgileriTable()
		{
			...
			Business = new OdemeBilgileriBusiness();
			Tablo = tablo;
			EventsLoad();
		...
		{
			tablo.GridControl.DataSource = ((OdemeBilgileriBusiness)Business).List(x => x.TahakkukId == OwnerForm.Id).ToBindingList<OdemeBilgileriL>();
		}
