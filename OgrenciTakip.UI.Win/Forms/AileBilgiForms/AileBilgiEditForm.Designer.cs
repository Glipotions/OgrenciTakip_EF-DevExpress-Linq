...
namespace OgrenciTakip.UI.Win.Forms.AileBilgiForms
{
	partial class AileBilgiEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtBilgiAdi = new OgrenciTakip.UI.Win.UserControls.Controls.MyTextEdit();
			...
			this.myToggleSwitch = new DevExpress.XtraLayout.LayoutControlItem();
			...
			((System.ComponentModel.ISupportInitialize)(this.myToggleSwitch)).BeginInit();
			this.SuspendLayout();
			// 
			// ribbonControl
			// 
			...
			// txtBilgiAdi
			// 
			this.txtBilgiAdi.Location = new System.Drawing.Point(65, 36);
			...
			this.txtBilgiAdi.StatusBarAciklama = "Bilgi Giriniz.";
			...
			// myToggleSwitch
			// 
			this.myToggleSwitch.AppearanceItemCaption.ForeColor = System.Drawing.Color.Maroon;
			this.myToggleSwitch.AppearanceItemCaption.Options.UseForeColor = true;
			this.myToggleSwitch.Control = this.tglDurum;
			this.myToggleSwitch.Location = new System.Drawing.Point(269, 0);
			this.myToggleSwitch.Name = "myToggleSwitch";
			this.myToggleSwitch.OptionsTableLayoutItem.ColumnIndex = 2;
			this.myToggleSwitch.Size = new System.Drawing.Size(99, 24);
			this.myToggleSwitch.TextSize = new System.Drawing.Size(0, 0);
			this.myToggleSwitch.TextVisible = false;
			// 
			// AileBilgiEditForm
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.myToggleSwitch)).EndInit();
		...
		private DevExpress.XtraLayout.LayoutControlItem myToggleSwitch;
	}
}