namespace OgrenciTakip.UI.Win.Forms.BaseForms
{
	partial class BaseEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ribbonControl.Size = new System.Drawing.Size(741, 109);
			...
			toolTipTitleItem4.Text = "Formda Yaptığınız Değişiklikler Onayınız Alınarak Veritabanına Kaydedilir.";
			...
			toolTipTitleItem6.Text = "Yaptığınız Değişiklikler Geri Alınarak Açılış Verileri Yüklenir.";
			...
			toolTipTitleItem8.Text = "Üzerinde Çalıştığınız Kayıt, Onayınıza Alınarak Silinir.";
