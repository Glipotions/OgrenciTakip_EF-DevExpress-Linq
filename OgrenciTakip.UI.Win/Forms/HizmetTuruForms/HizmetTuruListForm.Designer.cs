...
namespace OgrenciTakip.UI.Win.Forms.HizmetTuruForms
{
	partial class HizmetTuruListForm
	{
        ...
        private void InitializeComponent()
        {
			...
			this.colHimetTuruAdi = new OgrenciTakip.UI.Win.UserControls.Grid.MyGridColumn();
			this.colHizmetTipi = new OgrenciTakip.UI.Win.UserControls.Grid.MyGridColumn();
			...
			// colHimetTuruAdi
			// 
			this.colHimetTuruAdi.Caption = "Hizmet Turu Adı";
			this.colHimetTuruAdi.FieldName = "HizmetTuruAdi";
			this.colHimetTuruAdi.Name = "colHimetTuruAdi";
			this.colHimetTuruAdi.OptionsColumn.AllowEdit = false;
			this.colHimetTuruAdi.StatusBarAciklama = null;
			this.colHimetTuruAdi.StatusBarKisayol = null;
			this.colHimetTuruAdi.StatusBarKisayolAciklama = null;
			this.colHimetTuruAdi.Visible = true;
			this.colHimetTuruAdi.VisibleIndex = 1;
			this.colHimetTuruAdi.Width = 250;
			// 
			// colHizmetTipi
			// 
        ...
        private UserControls.Grid.MyGridColumn colHimetTuruAdi;
