...
namespace OgrenciTakip.UI.Win.Forms.FaturaForms
{
	partial class FaturaPlaniEditForm
	{
        ...
        private void InitializeComponent()
        {
			...
			this.faturaPlaniTable = new OgrenciTakip.UI.Win.UserControls.UserControl.FaturaEditFormTable.FaturaPlaniTable();
			...
			// 
			this.myDataLayoutControl1.Controls.Add(this.faturaPlaniTable);
			this.myDataLayoutControl1.Controls.Add(this.grid);
			this.myDataLayoutControl1.Controls.Add(this.txtMeslek);
			this.myDataLayoutControl1.Controls.Add(this.txtYakinlik);
			this.myDataLayoutControl1.Controls.Add(this.txtVeliSoyadi);
			this.myDataLayoutControl1.Controls.Add(this.txtVeliAdi);
			this.myDataLayoutControl1.Controls.Add(this.txtOgrenciNo);
			this.myDataLayoutControl1.Controls.Add(this.txtSinif);
			...
			this.myDataLayoutControl1.Size = new System.Drawing.Size(988, 516);
			...
			this.grid.Size = new System.Drawing.Size(564, 166);
			...
			this.txtMeslek.Location = new System.Drawing.Point(284, 117);
			...
			this.txtMeslek.StyleController = this.myDataLayoutControl1;
			...
			this.txtYakinlik.Location = new System.Drawing.Point(284, 93);
			...
			this.txtYakinlik.StyleController = this.myDataLayoutControl1;
			this.txtYakinlik.TabIndex = 10;
			// 
			// txtVeliSoyadi
			// 
			this.txtVeliSoyadi.Enabled = false;
			this.txtVeliSoyadi.EnterMoveNextControl = true;
			this.txtVeliSoyadi.Location = new System.Drawing.Point(284, 69);
			...
			this.txtVeliSoyadi.StyleController = this.myDataLayoutControl1;
			this.txtVeliSoyadi.TabIndex = 9;
			// 
			// txtVeliAdi
			// 
			this.txtVeliAdi.Enabled = false;
			this.txtVeliAdi.EnterMoveNextControl = true;
			this.txtVeliAdi.Location = new System.Drawing.Point(284, 45);
			...
			this.txtVeliAdi.StyleController = this.myDataLayoutControl1;
			this.txtVeliAdi.TabIndex = 8;
			// 
			// txtOgrenciNo
			// 
			this.txtOgrenciNo.Enabled = false;
			this.txtOgrenciNo.EnterMoveNextControl = true;
			this.txtOgrenciNo.Location = new System.Drawing.Point(84, 45);
			...
			this.txtOgrenciNo.StyleController = this.myDataLayoutControl1;
			...
			this.txtSinif.Location = new System.Drawing.Point(84, 117);
			...
			this.txtSinif.StyleController = this.myDataLayoutControl1;
			...
			this.txtAdi.Location = new System.Drawing.Point(84, 69);
            ...
            rowDefinition9,
            rowDefinition10});
			this.Root.Size = new System.Drawing.Size(988, 516);
            ...
            rowDefinition3,
            rowDefinition4});
			this.layoutControlGroup1.Size = new System.Drawing.Size(200, 170);
			...
			this.layoutControlItem3.Size = new System.Drawing.Size(176, 53);
			...
			this.layoutControlGroup2.Text = "Veli Bilgileri";
			// 
			// layoutControlItem5
			// 
			...
			this.layoutControlItem8.Size = new System.Drawing.Size(176, 53);
			...
			this.layoutControlItem9.Size = new System.Drawing.Size(568, 170);
			...
			this.faturaPlaniTable.Size = new System.Drawing.Size(964, 322);
			this.faturaPlaniTable.TabIndex = 13;
			// 
			// layoutControlItem11
			// 
			...
			this.layoutControlItem11.Control = this.faturaPlaniTable;
			...
			this.layoutControlItem11.Size = new System.Drawing.Size(968, 326);
		...
		private UserControls.UserControl.FaturaEditFormTable.FaturaPlaniTable faturaPlaniTable;
