...
namespace OgrenciTakip.UI.Win.Forms.OgrenciForms
{
	partial class OgrenciEditForm
	{
        ...
        private void InitializeComponent()
        {
			...
			this.txtCinsiyet = new OgrenciTakip.UI.Win.UserControls.Controls.MyComboBoxEdit();
			...
			this.ribbonControl.Size = new System.Drawing.Size(885, 109);
			...
			// popupMenuResim
			// 
			this.popupMenuResim.ItemLinks.Add(this.btnResimEkle);
			this.popupMenuResim.ItemLinks.Add(this.btnResimSil);
