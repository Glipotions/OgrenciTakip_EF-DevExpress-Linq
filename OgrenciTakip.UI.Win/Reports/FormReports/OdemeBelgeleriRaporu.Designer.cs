...
namespace OgrenciTakip.UI.Win.Reports.FormReports
{
	partial class OdemeBelgeleriRaporu
	{
        ...
        private void InitializeComponent()
        {
			...
			this.txtBelgeDurumlari = new OgrenciTakip.UI.Win.UserControls.Controls.MyCheckedComboBoxEdit();
			...
			this.colOgrenciSubeAdi = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			...
			this.colSinifGrupAdi = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.gridBand4 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
			this.colBelgeSubeAdi = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colPortfoyNo = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colOdemeTuruAdi = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colGirisTarihi = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colVade = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colHesabaGecisTarihi = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colTutar = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.repositoryDecimal = new DevExpress.XtraEditors.Repository.RepositoryItemCalcEdit();
			this.colIade = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colNetTutar = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			...
			this.colSonHaraketTarih = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colSonIslemYeri = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.gridBand1 = new DevExpress.XtraGrid.Views.BandedGrid.GridBand();
			this.colBankaAdi = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colBankaSubeAdi = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colBelgeNo = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colHesapNo = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colAsilBorclu = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colCiranta = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colHesapAdi = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colBlokeGunSayisi = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colTakipNo = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			this.colAciklama = new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn();
			...
			// 
			this.myDataLayoutControl1.Controls.Add(this.txtBelgeDurumlari);
			...
			this.myDataLayoutControl1.Size = new System.Drawing.Size(1013, 428);
			...
			this.txtBelgeDurumlari.Location = new System.Drawing.Point(710, 28);
			...
			this.txtBelgeDurumlari.Size = new System.Drawing.Size(299, 20);
			...
			this.txtBelgeDurumlari.StyleController = this.myDataLayoutControl1;
			this.txtBelgeDurumlari.TabIndex = 12;
			// 
			// txtOdemeler
			// 
			this.txtOdemeler.EnterMoveNextControl = true;
			this.txtOdemeler.Location = new System.Drawing.Point(710, 4);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.txtOdemeler.Size = new System.Drawing.Size(299, 20);
			...
			this.txtOdemeler.StyleController = this.myDataLayoutControl1;
			...
			this.grid.Size = new System.Drawing.Size(1009, 324);
    ...
    "aretleme\'";
            ...
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "Tahsil", this.colTahsil, "{0:n2}", "Tahsil"),
			...
			this.gridBand2.Caption = "Belgenin Alındığı Öğrencinin";
			this.gridBand2.Columns.Add(this.colOgrenciSubeAdi);
			...
			this.gridBand2.Columns.Add(this.colSinifGrupAdi);
			...
			this.gridBand4.Caption = "Ödeme Belgesi";
			this.gridBand4.Columns.Add(this.colBelgeSubeAdi);
			this.gridBand4.Columns.Add(this.colPortfoyNo);
			this.gridBand4.Columns.Add(this.colOdemeTuruAdi);
			this.gridBand4.Columns.Add(this.colGirisTarihi);
			this.gridBand4.Columns.Add(this.colVade);
			this.gridBand4.Columns.Add(this.colHesabaGecisTarihi);
			this.gridBand4.Columns.Add(this.colTutar);
			this.gridBand4.Columns.Add(this.colIade);
			this.gridBand4.Columns.Add(this.colNetTutar);
			this.gridBand4.Columns.Add(this.colTahsil);
			this.gridBand4.Columns.Add(this.colTahsilde);
			this.gridBand4.Columns.Add(this.colKalan);
			this.gridBand4.Columns.Add(this.colBelgeDurumu);
			this.gridBand4.Name = "gridBand4";
			this.gridBand4.VisibleIndex = 1;
			this.gridBand4.Width = 1475;
			// 
			// colBelgeSubeAdi
			// 
			...
			this.gridBand7.Caption = "Belgenin Son Hareket Bilgileri";
			this.gridBand7.Columns.Add(this.colSonHaraketTarih);
			this.gridBand7.Columns.Add(this.colSonIslemYeri);
			this.gridBand7.Name = "gridBand7";
			this.gridBand7.VisibleIndex = 2;
			this.gridBand7.Width = 260;
			// 
			// colSonHaraketTarih
			// 
			this.colSonHaraketTarih.AppearanceCell.Options.UseTextOptions = true;
			this.colSonHaraketTarih.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colSonHaraketTarih.AppearanceHeader.Options.UseTextOptions = true;
			this.colSonHaraketTarih.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colSonHaraketTarih.Caption = "Tarih";
			this.colSonHaraketTarih.ColumnEdit = this.repositoryTarih;
			this.colSonHaraketTarih.CustomizationCaption = "Son Hareket Tarihi";
			this.colSonHaraketTarih.FieldName = "SonHaraketTarih";
			this.colSonHaraketTarih.Name = "colSonHaraketTarih";
			this.colSonHaraketTarih.OptionsColumn.AllowEdit = false;
			this.colSonHaraketTarih.Visible = true;
			this.colSonHaraketTarih.Width = 90;
			// 
			// colSonIslemYeri
			// 
			...
			this.gridBand3.Columns.Add(this.colOzelKod3);
			this.gridBand3.Columns.Add(this.colOzelKod4);
			this.gridBand3.Columns.Add(this.colOzelKod5);
			...
			this.longNavigator1.Size = new System.Drawing.Size(1009, 22);
			...
			this.txtIptalDurumu.Location = new System.Drawing.Point(104, 52);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.txtIptalDurumu.Size = new System.Drawing.Size(470, 20);
			...
			this.txtKayitDurumu.Location = new System.Drawing.Point(394, 28);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.txtKayitDurumu.Size = new System.Drawing.Size(180, 20);
			...
			this.txtKayitSekli.Location = new System.Drawing.Point(104, 28);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.txtKayitSekli.Size = new System.Drawing.Size(184, 20);
			...
			this.txtSubeler.Location = new System.Drawing.Point(104, 4);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.txtSubeler.Size = new System.Drawing.Size(470, 20);
			...
			this.Root.Size = new System.Drawing.Size(1013, 428);
			...
			this.layoutControlItem6.Size = new System.Drawing.Size(1013, 26);
			...
			this.layoutControlItem7.Size = new System.Drawing.Size(1013, 328);
			...
			this.layoutControlItem9.Control = this.txtBelgeDurumlari;
			...
			this.layoutControlItem9.Text = "Belge Durumları";
        ...
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colSinifGrupAdi;
        ...
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colOgrenciSubeAdi;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colBelgeSubeAdi;
        ...
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colPortfoyNo;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colOdemeTuruAdi;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colGirisTarihi;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colVade;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colHesabaGecisTarihi;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colTutar;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colIade;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colNetTutar;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colTahsil;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colTahsilde;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colKalan;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colBelgeDurumu;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colSonHaraketTarih;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colSonIslemYeri;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colBankaAdi;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colBankaSubeAdi;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colBelgeNo;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colHesapNo;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colAsilBorclu;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colCiranta;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colHesapAdi;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colBlokeGunSayisi;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colTakipNo;
        private DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn colAciklama;
