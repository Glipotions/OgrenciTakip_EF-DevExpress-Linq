...
{
    public class OdemeBelgeleriRaporuBusiness : BaseHareketBusiness<OdemeBilgileri, OgrenciTakipContext>
    {
        public IEnumerable<OdemeBelgeleriRaporL> List(Expression<Func<OdemeBilgileri, bool>> filter, IEnumerable<BelgeDurumu> belgeDurumlari)
        {
            ...
            }).Select(x => new OdemeBelgeleriRaporL
            {
